<template>
  <div class="home">
    ...
    <q-page style="background-attachment: fixed;">
      <q-img class="img" src="https://s1.ax1x.com/2020/07/04/Nv2rxP.jpg">
        <div class="my-row bg-transparent">
          <div class="left">
            <q-card class="my-card" flat bordered v-for="(item,index) in articleList" :key="index">
          ...
          <div class="right q-ml-lg">
            <q-card class="my-card">
              <div class="q-pa-lg">
                ...
                <div class="bookmark q-mt-md q-mb-md">
                  <q-icon name="bookmark" class="icon q-mr-sm" />加入书签
                </div>
                <div class="text-center">
                  <font-awesome-icon class="fa fa-address-book-o" aria-hidden="true" />
                  <font-awesome-icon class="fab fa-github fa-2x q-mr-md avatar" />
                  <font-awesome-icon class="fab fa-weixin fa-2x q-mr-md avatar" />
                  <font-awesome-icon class="fab fa-zhihu fa-2x q-mr-md avatar" />
                  <svg
                    aria-hidden="true"
                    focusable="false"
                    data-prefix="fab"
                    ...
                    viewBox="0 0 640 512"
                    class="svg-inline--fa fa-zhihu fa-w-20 fa-2x q-mr-md avatar"
                  >
                    <path
                      fill="currentColor"
                  ...
                  <font-awesome-icon class="fas fa-envelope fa-2x avatar" />
                </div>
                <!-- <q-list>
                  <q-item clickable>
